...
import com.mingi.entity.MemberUsers;
import com.mingi.mapper.MemberMapper;
...
public class MemberUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException { //변수명 username고정되어있음 
		...
		if(mvo != null) {
				System.out.println("3. return값으로 new MemberUsers(mvo(username))생성자");
